...
public:
    ...
    //Temporary functions to test that loadMovies and loadPeople are working properly
    bool loadPeopleTest(string& personFile);
    bool loadMoviesTest(string& movieFile);
